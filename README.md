...
- **Data Visualization** — load a GLTF/IFC model, inspect element properties by clicking objects, toggle category visibility
- **IFC Export** — export the generated wall geometry as a standards-compliant IFC4 file
